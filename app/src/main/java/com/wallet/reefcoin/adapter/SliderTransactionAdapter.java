...
public class SliderTransactionAdapter extends PagerAdapter {
    /**
     * field instances of array list,context and layout inflater
     */
    ...
    /**
     * constructor for getting the current context and array list of values
     * @param context
     * @param arrayList
     */

    public SliderTransactionAdapter(Context context, ArrayList<String>arrayList) {
    ...
    /**
     * return the total item count by measuring the array list size
     * @return
     */
